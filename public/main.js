  ...
  var breadcrumbsElement = function breadcrumbsElement(element) {
    ...
    switch (siteMenuItem) {
      case _const_js__WEBPACK_IMPORTED_MODULE_1__.MenuItem.CATALOG:
        ...
        return "<li class=\"breadcrumbs__item breadcrumbs__item--current\"><a class=\"breadcrumbs__link\">".concat(title, "</a></li>");

      case _const_js__WEBPACK_IMPORTED_MODULE_1__.MenuItem.BASKET:
        title = element.BASKET;
        return "<li class=\"breadcrumbs__item\"><a href=\"#\" class=\"breadcrumbs__link\">".concat(element.CATALOG, "</a></li><li class=\"breadcrumbs__item breadcrumbs__item--current\"><a class=\"breadcrumbs__link\">").concat(title, "</a></li>");
    }
